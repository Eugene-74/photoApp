...
public class DateEdition {
    ...
    public static void  open(){
        ...
        label.setText("date : ");
        ImageData imageData = ImageData.getImageDataIfExist(ImageEdition.theCurrentImagePath);
        ...
        // System.out.println(Main.preferences.getString("day"));
        ...
        day.setPosition(-Main.preferences.getInteger("size of main images button")/2-Main.preferences.getInteger("size of main images button")*2, -50);

        month.setAlignment(Align.center);
        month.setPosition(-Main.preferences.getInteger("size of main images button")/2-Main.preferences.getInteger("size of main images button"), -50);
        ...
        min.setPosition(Main.preferences.getInteger("size of main images button")/2+Main.preferences.getInteger("size of main images button"), -50);

        s.setAlignment(Align.center);
        s.setPosition(Main.preferences.getInteger("size of main images button")/2+Main.preferences.getInteger("size of main images button")*2, -50);
        ...
        Main.placeImage(java.util.List.of("images/selected.png"), "basic button",
                ...
                (o) -> {       
                        ...
                        if(isYear&&isMonth&&isDay&&isHour&&isMin&&isS){
                                ...
                                date.add(s.getText());
                                ImageData.getImageDataIfExist(ImageEdition.theCurrentImagePath).setDate((date).get(0)+":"+(date).get(1)+":"+(date).get(2)+" "+(date).get(3)+":"+(date).get(4)+":"+(date).get(5));
                                clear();
